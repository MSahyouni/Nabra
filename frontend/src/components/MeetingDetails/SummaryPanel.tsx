...
export function SummaryPanel({
  ...
  const autoSubtitle = isLocalFallbackLanguage
    ? 'محفوظ على هذا الجهاز للاجتماعات التي بلا مجلد'
    : 'يستخدم اللغة الغالبة في التفريغ';
    ...
    const loadSummaryLanguage = async () => {
      try {
        ...
        toast.warning('تعذّر تحميل لغة الملخص المحفوظة', {
          description: 'سيُستخدم الاختيار التلقائي حتى تُقرأ بيانات الاجتماع.',
        });
        ...
        try {
          ...
          if (
            ...
            if (saved.storage === 'local_fallback') {
              toast.info('حُفظت لغة الملخص على هذا الجهاز', {
                description: 'لا يملك هذا الاجتماع مجلد تسجيل، لذلك تعذّر حفظ التفضيل ضمن بياناته.',
              });
            }
            if (request.language) {
          ...
          if (
            ...
            toast.error('فشل حفظ لغة الملخص');
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center flex-1">
            <div className="text-center">
              ...
              <p className="text-gray-600">جارٍ إنشاء الملخص الذكي...</p>
            </div>
          </div>
        </div>
      ) : !aiSummary ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
              <h3 className="text-lg font-semibold mb-2">ملخص الاجتماع</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium mb-1">النقاط الرئيسية</h4>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">المهام المطلوبة</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">القرارات</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">الموضوعات الرئيسية</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1">الملخص الكامل</h4>
