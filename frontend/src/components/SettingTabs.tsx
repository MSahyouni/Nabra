...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">التفريغ</TabsTrigger>
    <TabsTrigger value="modelSettings">التلخيص الذكي</TabsTrigger>
    <TabsTrigger value="recordingSettings">التفضيلات</TabsTrigger>
