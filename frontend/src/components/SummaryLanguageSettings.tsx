  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm relative">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-lg font-semibold text-gray-900">لغة الملخص</h3>
      </div>
      <p className="text-sm text-gray-600 mb-4">
        ثبّت لغة افتراضية للاجتماعات الجديدة. تبقى اللغات الأخرى خيارات سريعة، ويستخدم الوضع التلقائي اللغة الغالبة في التفريغ.
      </p>
          ...
          return (
            ...
            >
              <button
                ...
                title={isPinned ? 'اضغط لإلغاء اللغة الافتراضية' : 'اضغط لتعيينها لغة افتراضية'}
      ...
      <p className="text-xs text-gray-400 mt-3">
        {pinned
          ...
          : 'اضغط أي لغة لتعيينها افتراضية. يمكنك الاحتفاظ بخمسة خيارات سريعة.'}
      </p>
    </div>
  );
}
