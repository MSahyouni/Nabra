                    ...
                    {isRecording ? (
                        <>
                            ...
                            <p className="text-sm text-gray-600">
                                {isPaused ? 'التسجيل متوقف مؤقتًا' : 'جارٍ الاستماع للكلام...'}
                            </p>
                            <p className="text-xs mt-1 text-gray-400">
                                {isPaused ? 'اضغط استئناف لمتابعة التسجيل' : 'تحدث لرؤية التفريغ المباشر'}
                            </p>
                        </>
                    ) : (
                        <>
                            <p className="text-lg font-semibold">أهلًا بك في نَبْرَة!</p>
                            <p className="text-xs mt-1">ابدأ التسجيل لرؤية التفريغ المباشر</p>
                        </>
                    )}
                </motion.div>
            ) : useVirtualization ? (
                ...
                <>
                        ...
                        <div ref={loadMoreTriggerRef} className="flex justify-center items-center py-4 mt-2">
                            {isLoadingMore ? (
                                <div className="flex items-center gap-2 text-gray-500">
                                    ...
                                    <span className="text-sm">جارٍ تحميل المزيد...</span>
                                </div>
                    ...
                    {!isStopping && isRecording && !isPaused && !isProcessing && segments.length > 0 && (
                        ...
                        >
                            ...
                            <span className="text-sm">جارٍ الاستماع...</span>
                        </motion.div>
                    )}
                </>
            ) : (
